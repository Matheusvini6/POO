...
template <class T> class List {
    public:
        ...
        bool empty() const; // retorna true, caso a lista nao contenha nenhum elemento 
        Node<T>* begin(); // retorna apontador para a primeira posicao da lista
        Node<T>* end();// retorna apontador para a ultima posicao da lista
        void push_front(const T &x);// insere elemento no inicio da lista 
        void push_back(const T &x);// insere elemento no final da lista 
        Node<T>* erase(Node<T> *it);// remove o no da lista apontado por it e retorna um link 
                              //que aponta para o primeiro no restante apos o elemento removido, ou zero, 
                              //caso este elemento nao exista 
        void erase(const T& value);// remove os elementos de valor igual a T existentes na lista O(n)
        void clear();// apaga todos os nohs da lista 
