...
int main(){
    ...
    cout << "\nds é a distâcia do ponto M ao ponto N: \nds = " << ds << "u" << endl;
    cout << endl;

    Ponto2D *p3(m);
    cout << "P3 é o ponto incializado com as coordenadas do ponto M: \n" << "P3";
    m->print();

    Ponto2D *p4 = n;
    cout << "\nP4 é o ponto incializado com as coordenadas do ponto N: \n" << "P4";
    n->print();
